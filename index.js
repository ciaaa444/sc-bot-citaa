...
async function tampilkanHeader() {
  ...
  console.log(chalk.magenta.bold(`\n   ${bot_ku} — WhatsApp Bot by NoviOfficial 🌸`));
  console.log(chalk.gray(`   ${'-'.repeat(45)}`));
  console.log(chalk.white(`   Owner: ${chalk.bold(nameown)} | © RaidenMD | V1.0.0`));
  console.log(chalk.gray(`   ${'-'.repeat(45)}\n`));
}
...
function start(file) {
  ...
  console.log('\x1b[35m%s\x1b[0m', `🌸 RaidenMD — Bot by NoviOfficial`);
  console.log('\x1b[35m%s\x1b[0m', `📸 Instagram: https://instagram.com/fitya_taa`);
